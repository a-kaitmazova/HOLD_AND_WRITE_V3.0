...
namespace HOLD_AND_WRITE
{
    public partial class HoldAndWrite : Form
    {
        ...
        {
            MessageBox.Show("Файловая система - каталог папок \"Книги\",\"Места\",\"Персонажи\" и \"Предметы\". В \"Книги\" входят папки (по имени книги) с файлами текста и синопсиса в формате .txt" +
                ...
                "\n\nСинопсис - дополнительное поле ввода, файлы \"Синопсиса\" сохраняются вместе с файлами основного поля ввода. Название файлов \"Синопсиса\" состоит из имени файла, к которму пишется синопсис, и добавленными вначало двумя символами - \"@_\".",
